...
This project aims to analyze public sentiment on Twitter regarding climate change, particularly focusing on the belief that climate change is man-made. By leveraging Natural Language Processing (NLP) and machine learning models, we identify key topics and trends in tweets to support environmental advocacy organizations and the Environmental Protection Agency (EPA) in their efforts to understand and act upon public sentiment.
 
 This repo follows TDSP Project Structure. 
